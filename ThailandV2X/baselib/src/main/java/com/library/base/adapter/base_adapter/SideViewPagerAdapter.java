...
public class SideViewPagerAdapter extends FragmentPagerAdapter {
    ...
    public SideViewPagerAdapter(FragmentManager fm, ArrayList<Fragment> fragmentArray, List<String> mPageTitleList) {
        super(fm);
    ...
    public SideViewPagerAdapter(FragmentManager fm, List<String> mPageTitleList) {
        super(fm);
        this.title_arr = title_arr;
    }
