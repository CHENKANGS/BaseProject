...
//    public final static String API_HOST = "http://claim.uu139.com";
//    public final static String API_HOST = "http://192.168.1.123:81";
    public final static String API_HOST = "https://cloud.uu139.com";
//    public final static String API_HOST = "http://cloud.uu139.com";
...
//    public static final String REQUEST_SUCCESS = "0";
     ...
     * 数字常量把值包含在名字之中
     */
    public static final int NET_TIMEOUT_20 = 20;
    ...
    public static final int NET_CODE_400 = 400;//请求失败
    public static final int NET_CODE_401 = 401;//缺少认证参数，token
    public static final int NET_CODE_403 = 403;//认证失败
    public static final int NET_CODE_601 = 601;//用户已禁用
    public static final int NET_CODE_602 = 602;//用户认证失败
    public static final int NET_CODE_408 = 408;//服务器连接超时
    //500
