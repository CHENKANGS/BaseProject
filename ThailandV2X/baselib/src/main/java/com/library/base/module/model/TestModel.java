...
public class TestModel {
    ...
    public Observable<List<TestBean>> login(String userName, String password) {
...
//        return BaseApplication.getRetrofitClient().getChinaJesApi().getZXss("lvX0jaeZBIdwtHyz" , "e125579c07bad67d2bde9b3a79cdb6c2")
        return BaseApplication.getRetrofitClient().getChinaJesApi().getZXh(params)
                .map(new HttpResultFunc<List<TestBean>>())
//                .flatMap(new Func1<String, Observable<List<TestBean>>>() {
//                    @Override
//                    public Observable<List<TestBean>> call(String s) {
