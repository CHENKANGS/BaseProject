...
public class InitRetrofit {
    ...
    private OkHttpClient getOkHttpClient() {
        ...
        newBuilder.connectTimeout(GlobalConstant.NET_TIMEOUT_30, TimeUnit.SECONDS);
        newBuilder.readTimeout(GlobalConstant.NET_TIMEOUT_30, TimeUnit.SECONDS);
        newBuilder.writeTimeout(GlobalConstant.NET_TIMEOUT_30, TimeUnit.SECONDS);
