...
/**
 * @Description 水平控件工具
 * @date 2015-6-23 下午1:23:21
 * @Class cn.com.p2m.mornstar.jtjy.utils.widget.PagerSlidingTabStrip
 * @Author (chenkang@p2m.com.cn)
 * Copyright (c) 2015 Wuhan Mornstar Technology Co. Ltd.All rights reserved.
 */
...
//		tabTextColor = a.getColor(1, tabTextColor);
        ...
        selectedTabTextColor = a.getColor(R.styleable.PagerSlidingTabStrip_pstsSelectTextColor, selectedTabTextColor);
...
//		expandedTabLayoutParams = new LinearLayout.LayoutParams(0, LayoutParams.MATCH_PARENT, 1.0f);
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            if (pager.getAdapter() instanceof IconTabProvider) {
                ...
                addIconTextTab(i, ((IconTextTabProvider) pager.getAdapter()).getPageTitle(i).toString(), ((IconTextTabProvider) pager.getAdapter()).getPageIconResId(i));
            } else {
    ...
    private void addIconTextTab(final int position, String title, int resId) {
    ...
    private void updateTabStyles() {
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            if (v instanceof TextView) {
                ...
                TextView text = (TextView) ((LinearLayout) tabsContainer.getChildAt(i)).getChildAt(1);
