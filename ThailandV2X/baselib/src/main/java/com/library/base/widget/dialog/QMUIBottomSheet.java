...
public class QMUIBottomSheet extends Dialog {
    ...
    public static class BottomListSheetBuilder {
        ...
        private boolean mIsShowConfirm; //是否需要显示确定按钮
        private int mCheckedIndex;
        private String mTitle;
        private TextView mTitleTv;
        private ImageView image_close;
        private LinearLayout ll_confirm_button ;
        private TextView confirm_button ;
        private EditText editText_list ;
        ...
        public BottomListSheetBuilder(Context context, boolean needRightMark) {
            ...
            BottomSheetListItemData.sltText = "";//清空上次选择的信息
        }
        public BottomListSheetBuilder(Context context, boolean needRightMark , boolean isShowConfirm) {
            mContext = context;
            mItems = new ArrayList<>();
            mHeaderViews = new ArrayList<>();
            mNeedRightMark = needRightMark;
            mIsShowConfirm = isShowConfirm;
            BottomSheetListItemData.sltText = "";//清空上次选择的信息
        }
         ...
         * @return
         */
        public BottomListSheetBuilder addItem(Drawable image ,List<String> textAndTag) {
            for (int i = 0; i < textAndTag.size(); i++) {
                mItems.add(new BottomSheetListItemData(image ,textAndTag.get(i), textAndTag.get(i)));
            }
            return this;
        }
        ...
        public BottomListSheetBuilder setOnSelectorItemClickListener(OnSelectorItemClickListener onSelectorItemClickListener) {
            mOnSelectorItemClickListener = onSelectorItemClickListener;
            return this;
        }
        public BottomListSheetBuilder setOnConfirmClickListener(OnConfirmClickListener onConfirmClickListener) {
        ...
        private View buildViews() {
            ...
            ll_confirm_button = (LinearLayout) wrapperView.findViewById(R.id.ll_confirm_button);
            confirm_button = (TextView) wrapperView.findViewById(R.id.confirm_button);
            mContainerView = (ListView) wrapperView.findViewById(R.id.listview);
            editText_list = (EditText) wrapperView.findViewById(R.id.editText_list);
            //是否显示确定按钮
            if (mIsShowConfirm){
                ll_confirm_button.setVisibility(View.VISIBLE);
            }else {
                ll_confirm_button.setVisibility(View.GONE);
            }
            ...
            confirm_button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mOnConfirmClickListener != null){
                        mOnConfirmClickListener.onClick(mDialog, v ,editText_list ,BottomSheetListItemData.sltText);
                    }
                }
            });
            mAdapter = new ListAdapter(confirm_button , editText_list);
        ...
        public interface OnConfirmClickListener {
            void onClick(QMUIBottomSheet dialog, View confirm_button , EditText other_editText , String sltName);
        }
        public interface OnSelectorItemClickListener {
            void onClick(QMUIBottomSheet dialog, View itemView, int position, String tag , TextView confirm_button , EditText editText);
        }
        ...
        private class ListAdapter extends BaseAdapter {
            ...
            public ListAdapter(TextView confirm_button , EditText editText_list){
                this.confirm_button = confirm_button ;
                this.editText_list = editText_list ;
            }
            @Override
            public int getCount() {
                return mItems.size();
            ...
            public View getView(final int position, View convertView, ViewGroup parent) {
                ...
                if (mNeedRightMark) {
                    ...
                    if (mCheckedIndex == position) {
                        ...
                        holder.textView.setTextColor(mContext.getResources().getColor(R.color.main));
                        BottomSheetListItemData.sltText = holder.textView.getText().toString().trim();
                    } else {
                        holder.markView.setVisibility(View.GONE);
                        holder.textView.setTextColor(mContext.getResources().getColor(R.color.black_text_1b));
                    }
                } else {
                    holder.markView.setVisibility(View.GONE);
                    holder.textView.setTextColor(mContext.getResources().getColor(R.color.black_text_1b));
                ...
                convertView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (mOnSelectorItemClickListener != null){
                            mOnSelectorItemClickListener.onClick(mDialog, v, position, data.tag ,  confirm_button , editText_list);
                        }
