 ...
 * File: ShowMsgDialog.java

 * Author: k

 * Version: V100R001C01

 * Create: 2018/1/3 9:54
 ...
 * 2018/1/3 : Changes ShowMsgDialog.java (k);
...
public class ShowMsgDialog extends Dialog {
    ...
    public ShowMsgDialog(Context context, int themeResId) {
    ...
    /**
     * 生成默认的 {@link ShowMsgDialog}
     * <p>
     * 提供了一个图标和一行文字的样式, 其中图标有几种类型可选。见 {@link ShowMsgDialog.Builder.IconType}
     * </p>
     *
     * @see ShowMsgDialog.CustomBuilder
     */
    public static class Builder {
        ...
        private @ShowMsgDialog.Builder.IconType
         ...
         * 设置 icon 显示的内容
         *
         * @see ShowMsgDialog.Builder.IconType
         */
        public ShowMsgDialog.Builder setIconType(@ShowMsgDialog.Builder.IconType int iconType) {
         ...
         * 设置显示的文案
         */
        public ShowMsgDialog.Builder setTipWord(CharSequence tipWord) {
            mTipWord = tipWord;
            return this;
        }
        /**
         * 设置显示的文案
         */
        public void setTipText(CharSequence tipWord) {
            mTipWord = tipWord;
        }
         ...
         * @return 创建的 Dialog
         */
        public ShowMsgDialog create() {
            ShowMsgDialog dialog = new ShowMsgDialog(mContext);
    ...
    public static class CustomBuilder {
        ...
        public ShowMsgDialog.CustomBuilder setContent(@LayoutRes int layoutId) {
